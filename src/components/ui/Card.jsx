...
export function Card({ icon: Icon, title, description, variant = 'light', delay = 0 }) {
  const styles = {
    light: 'bg-cream border-t-2 border-gold/30 text-charcoal hover:shadow-[0_12px_40px_rgba(14,30,45,0.06)] hover:-translate-y-0.5',
    dark: 'bg-navy-light/50 border-t-2 border-gold/25 text-linen hover:shadow-[0_12px_40px_rgba(0,0,0,0.2)] hover:-translate-y-0.5',
  }
